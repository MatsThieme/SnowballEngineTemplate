...
export class Vector2 implements IVector2 {
    ...
    public static add(...vectors: IVector2[]): Vector2 {
        return vectors.reduce((a: Vector2, b: IVector2) => {
            a.x += b.x;
            a.y += b.y;
            return a;
        }, new Vector2());
    ...
    public static scale(
        vec: Vector2 | number,
        scalar: IVector2 | number,
        ...scalars: (number | IVector2)[]
    ): Vector2 {
    ...
    public toString(precision = 3): string {
        ...
        return `x: ${Math.round(this.x * precision) / precision}, y: ${
            Math.round(this.y * precision) / precision
        }`;
    }
