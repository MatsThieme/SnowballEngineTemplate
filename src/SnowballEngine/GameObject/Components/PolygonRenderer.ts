...
//     */
//    public constructor(gameObject: GameObject) {
//        throw new Error('Renderable not implemented');
...
//            this.size = this.polygonCollider.scaledSize;
//            this._position = new Vector2(topLeft.x, topLeft.y - this.polygonCollider.scaledSize.y).sub(this.gameObject.transform.toGlobal().position).sub(this.polygonCollider.align);
//        }, 100);
//    }
