import { Assets, AudioEffectDelay, AudioListener, AudioMixer, AudioSource, Destroy, Dispose, Timeout } from 'SE';
...
export class AudioSourceDelayEffect extends TestBehaviour {
    ...
    async test() {
        ...
        const e = mixer.addEffect(AudioEffectDelay, e => { e.seconds = 1; });
